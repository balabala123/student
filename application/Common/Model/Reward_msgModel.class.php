...
class Reward_msgModel extends CommonModel {
    ...
    protected $_validate = array(
        ...
        array('quota', 'require', '请填写名额！', 1, 'regex', CommonModel:: MODEL_BOTH ),
        ...
        array('type_name', 'checkAction', '奖学金类型已经存在！', 1, 'callback', CommonModel:: MODEL_INSERT   ),
